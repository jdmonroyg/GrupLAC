...
#.replace("aspx"+"\u0301","?")
    ...
    informacion=Plan_Estrategico_Grupo[index1+7:index2].split()
    for a in range(0,len(informacion)):
        Pe_Vision_Grupo= Pe_Vision_Grupo + informacion[a] + " "
    Plan_Estrategico_Grupo=Plan_Estrategico_Grupo[0:index1]
    #Retos
    index1 = Plan_Estrategico_Grupo.find("Retos:")
    index2 = len(Plan_Estrategico_Grupo)
    informacion=Plan_Estrategico_Grupo[index1+6:index2].split()
    for a in range(0,len(informacion)):
        Pe_Retos_Grupo= Pe_Retos_Grupo + informacion[a] + " "
    Plan_Estrategico_Grupo=Plan_Estrategico_Grupo[0:index1]
    #Objetivos
    index1 = Plan_Estrategico_Grupo.find("Objetivos:")
    index2 = len(Plan_Estrategico_Grupo)
    informacion=Plan_Estrategico_Grupo[index1+10:index2].split()
    for a in range(0,len(informacion)):
        Pe_Objetivos_Grupo= Pe_Objetivos_Grupo + informacion[a] + " "
    Plan_Estrategico_Grupo=Plan_Estrategico_Grupo[0:index1]
    #Estado del arte
    index1 = Plan_Estrategico_Grupo.find("Estado del arte:")
    index2 = len(Plan_Estrategico_Grupo)
    informacion=Plan_Estrategico_Grupo[index1+16:index2].split()
    for a in range(0,len(informacion)):
        Pe_Earte_Grupo= Pe_Earte_Grupo + informacion[a] + " "
    Plan_Estrategico_Grupo=Plan_Estrategico_Grupo[0:index1]
    #Plan de trabajo
    ...
    informacion=Plan_Estrategico_Grupo[index1+16:index2].split()
    for a in range(0,len(informacion)):
        Pe_Ptrabajo_Grupo= Pe_Ptrabajo_Grupo + informacion[a] + " "
